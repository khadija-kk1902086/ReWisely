...
export const UploadButton = () => {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (pathname === "/mind-map") {
      ...
      question = `Summarize this text well in ${numberOfWords} words with complexity of summary being ${questionComplexity}`;
    ...
    <div>
      <div>
        ...
        <form onSubmit={onSubmit} className="flex items-center justify-center">
          <label className="relative cursor-pointer bg-white rounded-md border border-gray-300 shadow-sm py-2 px-4 inline-flex items-center space-x-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
            <svg
          ...
          {pathname === "/flash-cards" && (
            <>
              ...
              <input
                ...
                className="ml-2 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                min={1}
                max={50}
              />
              <select
          ...
          <button
            type="submit"
            className="ml-2 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#340a63] hover:bg-[#D40689] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            Upload
          </button>
        </form>
